<x-filament-panels::page>
    <div class="space-y-6">
        ...
        @if ($this->reportData)
            ...
            <x-filament::section>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <dd class="text-sm font-semibold text-red-600 dark:text-red-400">{{ $summary['total'] }}</dd>
                    </div>

                    <div class="space-y-2">
                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Total Transaksi</dt>
                        <dd class="text-sm text-gray-900 dark:text-gray-100">{{ $summary['totalTransactions'] }}</dd>
                    </div>
                    ...
                    <div class="space-y-2">
                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Rata-rata Per Transaksi</dt>
                        <dd class="text-sm text-gray-900 dark:text-gray-100">{{ $summary['averagePerTransaction'] }}
                        </dd>
                    </div>
            ...
            {{-- Expenses By Needs Table --}}
            <x-filament::section>
                <x-slot name="heading">
                    <div class="flex items-center gap-2">
                        <x-heroicon-o-list-bullet class="w-5 h-5" />
                        Pengeluaran Berdasarkan Kebutuhan
                    </div>
                </x-slot>
                    ...
                    <div class="overflow-x-auto">
                        <table class="w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse($this->getExpensesByNeedsData() as $index => $data)
                                    <tr>
                                        <td
